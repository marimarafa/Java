...
public class ControllerVenditore {
	...
	@GetMapping(path = "/{id}/senza_prodotti",produces = "application/json")
	public VenditoreDTONOProdotti visualizzaSenzaProdotti(@PathVariable int id){
		return service.visualizzaSenzaProdotti(id);
	}
